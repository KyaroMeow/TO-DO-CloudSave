...
namespace TO_DO.Data
{
	public class DbRepository
	{
        ...
        ";
			...
			catch (SqliteException ex)
			{
				...
				// Логируйте или выбрасывайте дальше
				throw new InvalidOperationException("Ошибка при добавлении тега в базу.", ex);
			}
		}
    ...
    ";
		...
		public List<TagModel> GetAllTags()
		{
			...
			var cmd = new SqliteCommand("SELECT id, Name FROM Tags", connection);
